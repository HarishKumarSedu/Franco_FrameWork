...
class Ph1S1_Indcs_Offset_Trim:
    ...
    def Ph1S1_Indcs_Offset_Test__SetUp(self):
        ...
        for Instruction in self.DFT.get("Instructions"):
            ...
            if re.search(re.compile('TrimSweep'),Instruction):
                ...
                self.Ph1S1_Indcs_Offset_Values__Sweep()

    def Ph1S1_Indcs_Offset_Values__Sweep(self):
        self.supply.outp_OFF(channel=3)
        ...
        self.Ph1S1_Indcs_Offset_Limit__Check()

    def Ph1S1_Indcs_Offset_Limit__Check(self):
    ...
    def Ph1S1_Indcs_Offset_results (self):
