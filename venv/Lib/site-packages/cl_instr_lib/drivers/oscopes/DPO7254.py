...
class DPO7254(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO7254 Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO7254$',
            # TODO: Put in sim_idn and sim_opt values from an actual DPO7054 when we can get hands on one.
            sim_idn="TEKTRONIX,DPO7254,C140009,CF:91.1CT FV:10.8.3 Build 3",
...
if __name__ == '__main__':
    dpo7254 = DPO7254('GPIB::22')
    dpo7254.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
