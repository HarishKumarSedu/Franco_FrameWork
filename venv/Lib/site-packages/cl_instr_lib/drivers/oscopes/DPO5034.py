...
class DPO5034(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO5034 Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO5034$',
            sim_idn="TEKTRONIX,DPO5034,C011102,CF:91.1CT FV:10.8.3 Build 3",
            sim_opt="ASM: Advanced Search & Mark,DJA: Jitter and Eye Diagram Tools - Advanced",
            **kwargs)
...
if __name__ == '__main__':
    dpo5034 = DPO5034('USB0::0x0699::0x0503::C011102')
    dpo5034.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
