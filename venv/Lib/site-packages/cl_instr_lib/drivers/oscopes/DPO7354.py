...
class DPO7354(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO7354 Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO7354$',
            sim_idn='TEKTRONIX,DPO7354,C010179,CF:91.1CT FV:5.3.5 Build 22',
            sim_opt="ASM: Advanced Search & Mark,LT: Limit Test,DJE: Jitter and Eye Diagram Tools - Essentials,",
            **kwargs)
...
if __name__ == '__main__':
    dpo7354 = DPO7354('GPIB::21')
    dpo7354.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')