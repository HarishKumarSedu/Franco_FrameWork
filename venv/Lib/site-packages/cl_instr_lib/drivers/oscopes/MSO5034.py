...
class MSO5034(OscopeTekBase5k7k):
    """Driver class for Tektronix MSO5034 Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
                         model_re='^MSO5034$',
                         sim_idn="TEKTRONIX,MSO5034,C010989,CF:91.1CT FV:7.5.0 Build 1*",
                         sim_opt="ASM: Advanced Search & Mark,MSOE: 16-channel"
                                 " MSO,DJE: Jitter and Eye Diagram Tools - Essentials",
                         **kwargs)
...
if __name__ == '__main__':
    mso5034 = MSO5034('USB0::0x0699::0x0503::C010989')
    mso5034.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
