...
class DPO7254C(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO7254C Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO7254C$',
            # TODO: Put in sim_idn and sim_opt values from an actual DPO7054C when we can get hands on one.
            sim_idn="TEKTRONIX,DPO7254C,C140009,CF:91.1CT FV:10.8.3 Build 3",
            sim_opt="ASM: Advanced Search & Mark,SR-CUST: Custom Serial Analysis,DJA: Jitter and Eye Diagram Tools - "
                    "Advanced",
            **kwargs)
...
if __name__ == '__main__':
    dpo7254C = DPO7254C(None)  # 'GPIB::22')
    dpo7254C.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
