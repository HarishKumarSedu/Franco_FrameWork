    ...
    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
                         ...
                         sim_opt="SUP5-DVM:License; Digital voltmeter and trigger frequency counter; Node locked,"
                                 ...
                                 "Node locked,BW5-500:License; 500 MHz bandwidth on 5 Series Oscilloscopes; "
                                 "Node locked",
                         **kwargs
                         )
        ...
        #: The vertical object in turn composes channel objects for each channel named  CH1...CH8.
        self.vertical = Vertical(self, 8)
...
if __name__ == '__main__':
    # mso58 = MSO58('USB0::0x0699::0x0522::C011718')
    mso58 = MSO58('USB0::0x0699::0x0522::C043222')
    mso58.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
