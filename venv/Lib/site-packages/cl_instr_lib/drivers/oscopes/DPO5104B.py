...
class DPO5104B(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO5104B Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO5104B$',
            sim_idn='TEKTRONIX,DPO5104B,C052180,CF:91.1CT FV:10.8.3 Build 3',
            sim_opt="2RL: 50 Meg Max 25M/CH,ASM: Advanced Search & Mark,LT: Limit Test,VET: Visual Trigger and Search,"
                    "SR-CUST: Custom Serial Analysis,DJE: Jitter and Eye Diagram Tools - Essentials,",
            **kwargs)
...
if __name__ == '__main__':
    dpo5104b = DPO5104B('USB0::0x0699::0x0503::B030638') # 0x0699::0x0503::C052180')
    dpo5104b.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')