...
class DPO7354C(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO7354C Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO7354C$',
            sim_idn="TEKTRONIX,DPO7354C,C140009,CF:91.1CT FV:10.8.3 Build 3",
...
if __name__ == '__main__':
    dpo7354C = DPO7354C('GPIB::22')
    dpo7354C.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
