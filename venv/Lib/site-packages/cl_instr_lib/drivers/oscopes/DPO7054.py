...
class DPO7054(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO7054 Oscilloscope."""
    ...
    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            ...
            sim_idn='TEKTRONIX,DPO7054,C130422,CF:91.1CT FV:10.7.1 Build 21',
...
if __name__ == '__main__':
    dpo7054 = DPO7054(None)    #  'GPIB0::1')
    dpo7054.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
