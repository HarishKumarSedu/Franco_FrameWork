...
class DPO5054(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO5054 Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO5054$',
            sim_idn="TEKTRONIX,DPO5054,B010259,CF:91.1CT FV:10.8.3 Build 3",
...
if __name__ == '__main__':
    dpo5054 = DPO5054('USB0::0x0699::0x0503::B010259')
    dpo5054.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
