...
from cl_instr_lib.base_classes.tek_scopes.dpo_mso_5k7k.trigger_5k_7k.trigger_dpo_5k import Trigger_DPO_5k
...
class DPO5054B(OscopeTekBase5k7k):
    """Driver class for Tektronix DPO5054B Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^DPO5054B$',
            # TODO: Fix with actual values. These idn, opt value copied (and modified) from MSO5054 (not B model).
            sim_idn="TEKTRONIX,DPO5054B,B010259,CF:91.1CT FV:10.8.3 Build 3",
            sim_opt="ASM: Advanced Search & Mark,DJE: Jitter and Eye Diagram Tools - Essentials",
            **kwargs)
        ...
        self.trigger = Trigger_DPO_5k(self)
...
if __name__ == '__main__':
    dpo5054b = DPO5054B('USB0::0x0699::0x0503::C052180')  # TODO: Replace address with an actual DPO5054B address.
    dpo5054b.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
