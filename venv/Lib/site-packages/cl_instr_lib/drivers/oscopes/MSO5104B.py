...
from cl_instr_lib.base_classes.tek_scopes.dpo_mso_5k7k.trigger_5k_7k.trigger_mso_5k import Trigger_MSO_5k
from cl_instr_lib.base_classes.tek_scopes.dpo_mso_5k7k.vertical_5k_7k import Vertical_5k_7k
from cl_instr_lib.base_classes.tek_scopes.dpo_mso_5k7k.digital import Digital
...
class MSO5104B(OscopeTekBase5k7k):
    """Driver class for Tektronix MSO5104B Oscilloscope."""

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
            model_re='^MSO5104B$',
            sim_idn="TEKTRONIX,MSO5104B,C031053,CF:91.1CT FV:10.8.3 Build 3",
            sim_opt="2RL: 50 Meg Max 25M/CH,ASM: Advanced Search & Mark,LT: Limit Test,MSOE: 16-channel MSO,"
                    "VET: Visual Trigger and Search,SR-CUST: Custom Serial Analysis,"
        ...
        self.trigger = Trigger_MSO_5k(self)

        #: Object containing the **vertical channel** controls. See `vertical class`_.
        self.vertical = Vertical_5k_7k(self)

        #: Object containing methods for **digital** operations. See `Digital`_ and `DigitalBit`_ classes
...
if __name__ == '__main__':
    mso5104b = MSO5104B('USB0::0x0699::0x0503::C031053')
    mso5104b.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
