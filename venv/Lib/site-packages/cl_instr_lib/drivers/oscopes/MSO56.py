...
class MSO56(OscopeTekBaseMso456):

    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        super().__init__(visa_resource_name, logger,
                         model_re='^MSO56$',
                         sim_idn='TEKTRONIX,MSO56,B026497,CF:91.1CT FV:1.40.3.236',
                         sim_opt="SUP5-DVM:License; Digital voltmeter and trigger frequency counter; "
                                 "Node locked,SUP5-DVM:License; Digital voltmeter and trigger frequency counter; "
                                 "Node locked,BW5-1000:License; 1 GHz bandwidth on 5 Series Oscilloscopes;"
                                 "Node locked license",
                         **kwargs
                         )
...
if __name__ == '__main__':
    mso56 = MSO56('USB0::0x0699::0x0522::B026497')
    mso56.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
