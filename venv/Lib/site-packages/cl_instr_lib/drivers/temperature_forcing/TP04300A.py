...
class TP04300A(Temp_BaseClass):
    """
    Class for controlling a TP04300A temperature forcing system
    """
    ...
    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        ...
        super().__init__(visa_resource_name,
                         logger=logger,
                         model_re='^TP04300A',
                         sim_idn='Temptronic., Model TP04300A',
                         **kwargs)
...
if __name__ == "__main__":
    tp04300A = TP04300A('GPIB0::19')  # Replace visa_resource_name with None for simulated hardware.
    tp04300A.debug_options(log_scpi=True, inst_error_handling='LOG_ALWAYS')
