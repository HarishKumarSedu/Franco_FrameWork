...
class AFG3102C(Afg3kBase):
    """Driver class for Tektronix AFG3102C Dual Output function generator"""
    ...
    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        chan_pgm_bounds = ProgrammingBounds(
            ...
            freq_min=1e-3, freq_max={
                'SINE': 100e6, 'SQUARE': 50e6, 'PULSE': 50e6, 'ARB': 50e6, 'OTHER': 1e6
            },
            ...
            fm_deviation_max=50e6,                     # TODO: See data sheet is function of wave shape
        ...
        super().__init__(visa_resource_name, chan_pgm_bounds, logger,
                         model_re='^AFG3102C$',
                         sim_idn='TEKTRONIX,AFG3102C,C010789,SCPI:99.0 FV:1.0.10',
                         **kwargs)

if __name__ == '__main__':
    afg3102c = AFG3102C('USB0::0x0699::0x034C::C010789')  # Replace visa_resource_name with None for simulated hardware.
    afg3102c.debug_options(log_scpi=True, unused_args_handling='LOG_UNUSED', inst_error_handling='LOG_ALWAYS')
