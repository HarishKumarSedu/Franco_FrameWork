...
class AFG3252(Afg3kBase):
    """Driver class for Tektronix AFG3252 Dual Output function generator"""
    ...
    def __init__(self, visa_resource_name=None, logger=None, **kwargs):
        ...
        chan_pgm_bounds = ProgrammingBounds(
            ...
            offset_hiz_min=-5, offset_hiz_max=5,    # Open circuit load, scaled for other loads in function_level.
            voltage_window_hiz_min=-10, voltage_window_hiz_max=10,
            freq_min=1e-3, freq_max={
                'SINE': 240e6, 'SQUARE': 120e6, 'PULSE': 120e6, 'ARB': 120e6, 'OTHER': 2.4e6
            },
        ...
        super().__init__(visa_resource_name, chan_pgm_bounds, logger,
                         model_re='^AFG3252$',
                         sim_idn='TEKTRONIX,AFG3252,C010767,SCPI:99.0 FV:3.2.4',
                         **kwargs)

if __name__ == '__main__':
    afg3252 = AFG3252('GPIB0::11')  # 'USB0::0x0699::0x0345::C021277')  # Replace visa_resource_name with None for
    # simulated hardware.
    afg3252.debug_options(log_scpi=True, unused_args_handling='LOG_UNUSED', inst_error_handling='LOG_ALWAYS')
