...
class Oscope_MSO5204B(oscope_DPO5034B.Oscope_DPO5034B):

    def __init__(self, rmHandle):
        self.rmHandle = rmHandle
        self.logger = logging.getLogger('marv.inst.Oscope_MSO5204B')
        self.logger.info('Initializing Oscope_MSO5204B instrument')
...
if __name__ == "__main__":
    ...
    scope = instMgr.checkout(interface='USB', addr='0x0699::0x0401::C001911', moduleSuffix='MSO5204B')
    scope.reset()
    print(scope.getIdn())
