...
class Oscope_MSO4034(oscope_DPO4034.Oscope_DPO4034):

    def __init__(self, rmHandle):
        self.rmHandle = rmHandle
        self.logger = logging.getLogger('marv.inst.Oscope_MSO4034')
        self.logger.info('Initializing Oscope_MSO4034 instrument')
...
if __name__ == "__main__":
    ...
    scope = instMgr.checkout(interface='USB', addr='0x0699::0x0401::C001911', moduleSuffix='MSO4034')
    scope.reset()
    print(scope.getIdn())
