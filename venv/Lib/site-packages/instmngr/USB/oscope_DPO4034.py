...
class Oscope_DPO4034(oscope_DPO4104B.Oscope_DPO4104B):

    def __init__(self, rmHandle):
        self.rmHandle = rmHandle
        self.logger = logging.getLogger('marv.inst.Oscope_DPO4034')
        self.logger.info('Initializing Oscope_DPO4034 instrument')
...
if __name__ == "__main__":
    ...
    scope = instMgr.checkout(interface='USB', addr='C021305', moduleSuffix='DPO4034')
    scope.reset()
    print(scope.getIdn())
