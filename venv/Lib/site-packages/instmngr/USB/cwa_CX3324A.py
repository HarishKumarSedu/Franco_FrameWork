# -*- coding: utf-8 -*-
"""
Class for controlling Keysight Device Current Waveform Analyzer CX3324A.
...
if __name__ == "__main__":
    ...
    cntr = instMgr.checkout(objName='supply', interface='GPIB', addr=12, moduleSuffix='CX3324A')
