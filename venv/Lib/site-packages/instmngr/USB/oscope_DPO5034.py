...
class Oscope_DPO5034(oscope_DPO5034B.Oscope_DPO5034B):

    def __init__(self, rmHandle):
        self.rmHandle = rmHandle
        self.logger = logging.getLogger('marv.inst.Oscope_DPO5054B')
        self.logger.info('Initializing Oscope_DPO5054B instrument')
 ...
 # TODO: Add additional code here to support DPO features.
...
if __name__ == "__main__":
    ...
    scope = instMgr.checkout(interface='USB', addr='0x0699::0x0503::C010643', moduleSuffix='DPO5034')
    scope.reset()
    print(scope.getIdn())
