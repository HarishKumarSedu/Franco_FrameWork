...
class PwrMeter_N6705C():
    ...
    instDict = {
                'source': {
                    ...
                    'initcont': ['1', {'ture': '1', 'false': '0'}, 'INIT:CONT:TRAN '],
                    ...
                    'voltagerange':[9.9e+37, (0, 9.9e+37), 'SOUR:VOLT:RANG '],   # volt/s
                    'voltageslewimm':[100, (5, 1000), 'SOUR:VOLT:SLEW '],
                    ...
                    'digitinput': [],
                    'digitoutput': [],
                    'digittoutbusenable': ['1', {'ture': '1', 'false': '0'}, 'SOUR:DIG:TOUT:BUS '],
...
#                    'measarray': [':CURR?', {'current':':CURR?', 'voltage':':VOLT?', 'power':':POW?'}, 'MEAS:ARR'],
    ...
    def setListParam(self, param='voltage', val='0', ch=1):
...
if __name__ == "__main__":
    ...
    pm = instMgr.checkout(objName='pewmeter', interface='GPIB',addr=7,moduleSuffix='N6705C')
    pm.reset()
    print(pm.getIdn())
