...
* Created by WISCE.exe utility version 3.5.0.13 at 10/08/2016 12:47:38
*
* Devices on system:
*   CS47L91 at SMBUS/0x34
...
* ----- ------ -------------------- ------- --------- ------------------------------
   0xEE 0x000A SMbus_16inx_16dat     Write  0x44      * COMMS_CTRL_2(EEH):       000A  EXT_SPI_SEL=0, EXT_SPI_FPGA_ENA=0, EXT_SPI_DIR=0, SPI0_FPGA_ROUTING_ENA=1, SPI_PASS_SEL=0, SPI_PASS_ENA=1, STANDALONE_ENA=0
   0x1E 0x8007 SMbus_16inx_16dat     Write  0x44      * CDC_MCLK1_CTRL(1EH):     8007  CDC_MCLK1_ENA=1, CDC_MCLK1_SRC=0000_0111