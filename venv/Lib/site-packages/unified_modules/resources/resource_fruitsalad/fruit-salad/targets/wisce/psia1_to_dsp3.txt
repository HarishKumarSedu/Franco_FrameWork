...
* Created by WISCE.exe utility version 3.2.5.3 at 25/03/2015 14:24:44
*
* Devices on system: 
...
* ----- ------ -------------------- ------- --------- ------------------------------
  ...
  0x102 0x0012 SMbus_32inx_16dat     Write  0x34      * Sample rate 1(102H):     0003  SAMPLE_RATE_1=16kHz
  ...
  0x408 0x1000 SMbus_32inx_16dat     Write  0x34      * Output Rate 1(408H):     1000  OUT_RATE=Sample Rate 3
...
* Finished LOAD_FILE C:\Users\esmith\Documents\My Received Files\acra_ts2k.txt
  ...
  0x9D0 0x0020 SMbus_32inx_16dat     Write  0x34      * DSP3AUX1MIX Input 1 Source(9D0H): 0020  DSP3AUX1MIX_STS=0, DSP3AUX1_SRC=AIF1RX1
  0x9D8 0x0021 SMbus_32inx_16dat     Write  0x34      * DSP3AUX2MIX Input 1 Source(9D8H): 0021  DSP3AUX2MIX_STS=0, DSP3AUX2_SRC=AIF1RX2
  0x9E0 0x0022 SMbus_32inx_16dat     Write  0x34      * DSP3AUX3MIX Input 1 Source(9E0H): 0022  DSP3AUX3MIX_STS=0, DSP3AUX3_SRC=AIF1RX3
  0x9E8 0x0023 SMbus_32inx_16dat     Write  0x34      * DSP3AUX4MIX Input 1 Source(9E8H): 0023  DSP3AUX4MIX_STS=0, DSP3AUX4_SRC=AIF1RX4
  0x9F0 0x0024 SMbus_32inx_16dat     Write  0x34      * DSP3AUX5MIX Input 1 Source(9F0H): 0024  DSP3AUX5MIX_STS=0, DSP3AUX5_SRC=AIF1RX5
  0x9F8 0x0025 SMbus_32inx_16dat     Write  0x34      * DSP3AUX6MIX Input 1 Source(9F8H): 0025  DSP3AUX6MIX_STS=0, DSP3AUX6_SRC=AIF1RX6
...
0x8D0 0x0020 SMbus_32inx_16dat     Write  0x34      * DRC2LMIX Input 1 Source(8D0H): 0020  DRC2LMIX_STS1=0, DRC2LMIX_SRC1=AIF1RX1

BLOCK_WRITE 0x39005E SMbus_32inx_16dat 0x34 * FIRMWARE_FLORIDA_EZ2CONTROL25A_USESADTRIGGER_1
00000000
END
