...
class GpioExtender(Component):
    ...
    def _check_pin_valid(self, pin: int) -> Pin:
        ...
        :type pin: int
        :return: pin corresponding to pin number given
        :rtype: Pca9535Pin
        """
    ...
    def get_pin_value(self, pin: int) -> int:
        ...
        If direction is OUTPUT, returns drive level. If direction is INPUT, returns the measured level of the pin.
